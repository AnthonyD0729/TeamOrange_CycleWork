...
score_font = "font.ttf"
final_score_font = "font.ttf"
new_high_font = "font.ttf"
title_font = "font.ttf"
...
score_fx = pygame.mixer.Sound('click.wav')
score_fx.set_volume(0.2)
score_page_fx = pygame.mixer.Sound('score.mp3')
explode_fx = pygame.mixer.Sound('explode.wav')
...
close_img = pygame.image.load('closeBtn.png')
