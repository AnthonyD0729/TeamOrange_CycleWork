...
def main(test: bool = False) -> None:
    ...
    play_options.add.button(f'Back', pygame_menu.events.BACK)
    play_options.add.button(f'Controls', controlspage)
    play_options.add.button(f'Sound', pygame_menu.events.SOUND)
    play_options.add.button(f'Back', pygame_menu.events.BACK)
    play_options.add.button(f'Fullscreen', pygame_menu.events.BACK)
    play_options.add.button(f'Back', pygame_menu.events.BACK)
